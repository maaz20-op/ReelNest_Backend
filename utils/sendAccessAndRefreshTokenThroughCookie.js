...
function sendAccessAndRefreshTokenThroughCookies(userEmail, res) {
  ...
  res.cookie("accessToken", accessToken, {
    ...
    sameSite: false, // only HTTPS in productioin // or "Strict" to prevent csrf attack it may not send cookie from unauthorized website
  ...
  res.cookie("refreshToken", refreshToken, {
    httpOnly: true,
    secure: true, // Must be true for SameSite=None to work
    sameSite: false, // only HTTPS in prod // or "Strict" / "None" based on frontend-backend location
